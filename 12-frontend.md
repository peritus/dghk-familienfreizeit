...
So: render everything in React, admin and family portal alike, and keep the server
...
The family portal requires JavaScript. It is a small bundle that never contains the
...
([family portal](10-family-portal.md)). A control change posts the label event and
